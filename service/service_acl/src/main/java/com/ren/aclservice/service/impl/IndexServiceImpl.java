...
import com.ren.aclservice.entity.Role;
import com.ren.aclservice.entity.User;
import com.ren.aclservice.service.IndexService;
...
public class IndexServiceImpl implements IndexService {
    ...
    public Map<String, Object> getUserInfo(String username) {
        ...
        if (null == user) {
            //throw new ReclException(ResultCodeEnum.FETCH_USERINFO_ERROR);
        }
        ...
        String avatar = user.getAvatar() == null ?"https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif":user.getAvatar();
